...
namespace BotPollo
{
    class Program
    {
        ...
        public static DiscordSocketClient GetProgram() { return DiscordClient; }
        ...
        public async Task MainAsync(string[] args)
        {
            try
            {
                ...
                Token = "NzU2MTUzNzk2NDY3NDkwOTA3.X2NtGQ.AaRGXC-fFOEFFlr3vQ5E2oUZUtc"; //It's already expired of course
