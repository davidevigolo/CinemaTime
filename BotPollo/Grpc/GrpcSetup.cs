using BotPollo.Grpc.Services;
using Grpc.AspNetCore.Server;
using Microsoft.AspNetCore.Builder;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.DependencyInjection;

namespace BotPolloG.Grpc
{
    public class GrpcSetup
    {
        public static void GrpcStartup(string[] args)
        {
            Thread grpcThread = new Thread(() =>
            {
                Serilog.Log.Information("Starting grpc service");
                ...
                Serilog.Log.Information($"Grpc service started");
